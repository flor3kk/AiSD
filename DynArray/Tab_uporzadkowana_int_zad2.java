...
public class Tab_uporzadkowana_int_zad2 {
    ...
    public static void main(String[] args)
    {
        ...
        Tab_uporzadkowana_int_zad2 array = new Tab_uporzadkowana_int_zad2(maxSize); 	// tworzymy tablice

...
public class Tab_uporzadkowana_string_zad2 {
    private String [] table;  //Referencja do tablicy
    private int nElems;  //Aktualna liczba elementow w tablicy

    public Tab_uporzadkowana_string_zad2(int maxSize)  // Konstruktor
    {
    ...
    {
        int maxSize = 2;
        Tab_uporzadkowana_string_zad2 array = new Tab_uporzadkowana_string_zad2(maxSize);
        array.add("Ola");
        array.add("Ala");
        array.add("Tola");
        array.print();
